        ...
        <div className="flex flex-col gap-5">
          ...
          {!cli && (
            ...
            >
              ...
              {/* ========== TEMP: TEST BUTTONS - REMOVE BEFORE PRODUCTION ========== */}
              <div className="flex flex-col gap-2">
                <Button
                  type="button"
                  variant="outline"
                  className="h-10 rounded-xl gap-2 border-dashed border-orange-500 text-orange-600 hover:bg-orange-50 text-xs"
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="h-10 rounded-xl gap-2 border-dashed border-blue-500 text-blue-600 hover:bg-blue-50 text-xs"
